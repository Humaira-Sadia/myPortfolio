          ...
          <div className="absolute inset-0 flex justify-end m-3 card-img_hover">
            ...
            >
              <img
                src={github}
                alt="source code"
                className="w-full h-full object-contain bg-black rounded-full hover:scale-90 hover:bg-green-600"
              />
            </div>
          </div>
        </div>
...
const Works = () => {
  return (
    <div id="project">
      ...
      <div className="mt-20 flex justify-center jusc flex-wrap gap-7">
